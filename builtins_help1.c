...
/**
 * help_exit - shows info on the shellby builtin command 'exit'.
 */
...
/**
 * help_help - shows info on the shellby builtin command 'help'.
 */
void help_help(void)
{
...
/**
 * help_cd - shows info on the shellby builtin command 'cd'.
 */
...
/**
 * help_alias - shows info on the shellby builtin command 'alias'.
 */
void help_alias(void)
{
